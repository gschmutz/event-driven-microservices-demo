...
import com.trivadis.ms.sample.order.service.OrderService;
...
public class OrderController {
    ...
    @Transactional
    public void postOrder(@RequestBody OrderApi orderApi) throws ParseException {
    ...
    @RequestMapping(value= "/api/order",
            ...
            consumes = "application/json") 
    @Transactional
    public void putOrder(@RequestBody OrderApi orderApi) throws ParseException {
        Preconditions.checkNotNull(orderApi);
